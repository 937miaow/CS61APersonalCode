...
def without(s, i):
    ...
    # if i == 0:
    #     return s.rest
    # while original_cur is not Link.empty:
    #     if index == i:
    #         original_cur = original_cur.rest
    #     else:
    #         cur.rest = Link(original_cur.first)
    #         cur = cur.rest
    #         original_cur = original_cur.rest
    #     index += 1
    # return copy
    if s is Link.empty:
        return Link.empty
    if i == 0:
        return s.rest  # Skip the first element
        # Create a copy of s with the element at index i removed
